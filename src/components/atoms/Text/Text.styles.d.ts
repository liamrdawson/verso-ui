import { ITheme, ITypeScale, ITypeWeight } from '@aperture-ui/theme';
/**
 ...
 */
export declare const textStyles: (theme?: ITheme) => (fontWeight?: keyof ITypeWeight, fontSize?: keyof ITypeScale) => import("@emotion/utils").SerializedStyles;
